...
export const createUserProject = async (req: Request, res: Response) => {
    ...
    try {
        ...
        await prisma.conversation.create({
            data: {
                role: 'assistant',
                content: "I've generated your website. You can now view it and request any changes.",
                projectId: project.id,
            }
        })
...
// Contoller Function - get all user projects
...
export const purchaseCredits = async (req: Request, res: Response) => {
    try {
        ...
        const plans = {
            basic : { amount : 5, credits : 100 },
            pro : { amount : 19, credits : 400 },
            enterprise : { amount : 49, credits : 1000 }
        }
        ...
        const session = await stripe.checkout.sessions.create({
            ...
            line_items: [
                ...
                price_data : {
                    currency : 'usd',
                    product_data : {
                        name : `AI SiteBuilder - ${plan.credits} Credits`
                    },
