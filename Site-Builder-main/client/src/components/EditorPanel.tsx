    ...
    return (
        <div className = 'absolute top-4 right-4 w-80 bg-white rounded-lg shadow-xl border border-gray-200 p-4 z-50 animate-fade-in fade-in slide-in-from-right-5'>
            ...
            <div className='flex items-center justify-between mb-3'>
                ...
                <button className = 'p-1 rounded-full hover:text-gray-100' 
                    onClick = {onClose}> 
            ...
            <div className = 'space-y-4 text-black'>
                <div>
                    <label className="block text-xs font-medium text-gray-500 mb">
                        Text Content
                    </label>
                    <textarea value={values.text} 
                        ...
                        className = 'w-full text-sm p-2 border border-gray-400rounded-md focus:ring-2 focus:ring-indigo-500 outline-none min-h-20'
                    />
                </div>
                ...
                <div className = 'grid grid-cols-2 gap-3'>
                    <div>
                        ...
                        <div className = 'flex items-center gap-2 border border-gray-400 rounded-md p-1'>
                            ...
                            <span className = 'text-xs text-gray-600 trunucate'> {values.styles.backgroundColor} </span>
                        </div>
                    ...
                    <div>
                        ...
                        <div className = 'flex items-center gap-2 border border-gray-400 rounded-md p-1'>
                            ...
                            className = 'w-6 h-6 cursor-pointer'/>
                            <span className = 'text-xs text-gray-600 trunucate'> {values.styles.color} </span>
