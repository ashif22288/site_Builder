                        ...
                        <div>
                            {
                                ...
                                hover:bg-indigo-600 active:scale-95 transition-all'
                                    ...
                                    py-1 sm:py-2 rounded-md bg-gradient-to-br from-indigo-500 to-indigo-600
                                    hover:bg-indigo-600 active:scale-95 transition-all'
                                            ><PlusIcon size={18} /> Create New Project</button>
                                        ...
                                        <div className='flex flex-wrap gap-3.5'>
                                            {
                                                projects.map((project) => (
                                                    <div onClick={() => navigate(`/projects/${project.id}`)} key={project.id}
                                                        ...
                                                        hover:border-indigo-8000/80 transition-all duration-300'>

                                                        {/*
                                                            Desktop Mini-view Preview
                                                        */}
                                                        <div className='relative w-full h-40 bg-gray-900
                                                overflow-hidden border-b border-gray-700'>
                                                            {
                                                                project.current_code ? (
                                                                    <iframe srcDoc={project.current_code} frameBorder="0"
                                                        ...
                                                        <div>
                                                            <div className='p-4 text-white bg-linear-180 from-transparent 
                                                                group-hover:from-indigo-950 to-indigo-transparent transition-colors'>
                                                                <div className='flex items-start justify-between'>
                                                                    <h1 className='text-lg font-medium 
                                                                        line-clamp-2'>{project.name}</h1>
                                                            ...
                                                            <div onClick={(e) => e.stopPropagation()}>
                                                                <TrashIcon className='absolute top-3 right-3  scale-0 group-hover:scale-100
                                                                    bg-white p-1.5 size-7 rounded text-red-500 text-xl cursor-pointer transition-all'
