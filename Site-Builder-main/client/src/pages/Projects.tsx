    ...
    return project ? (
        <div className='flex flex-col h-screen w-full bg-gray-900 text-white'>
            ...
            <div className='flex max-sm:flex-col sm:items-center gap-4 px-4 py-2 no-scrollbar'>
                ...
                {/* {left} */}
                <div className='flex items-center gap-2 sm:min-2-90 text-nowrap'>
                ...
                {/* {middle} */}
                <div className='hidden sm:flex gap-2 bg-gray-950 rounded-md p-1.5'>
                    <SmartphoneIcon
                        onClick={() => setDevice('phone')}
                        className={`
                            size-6 p-1 rounded cursor-pointer
                            ${device === 'phone' ? 'bg-gray-800' : ''}
                        `}
                    />
                ...
                <div className='flex items-center justify-end gap-3 flex-1 text-xs sm:text-sm'>
                    ...
                    <button disabled={isSaving} className={`
                        max-sm:hidden bg-gray-800 hover:bg-gray-700 text-white
                    ...
                    <Link target='_blank' to={`/preview/${projectId}`}
                        className={
                            `flex items-center gap-2 px-4 py-1 sm:rounded-sm rounded border border-gray-700
                    ...
                    <button className={
                        `bg-linear-to-br from-blue-700 to-blue-600 hover:from-blue-600 hover:to-blue-500
                    ...
                    <button className={
                        `bg-linear-to-br from-indigo-700 to-indigo-600 hover:from-indigo-600 hover:to-indigo-500
                        text-white px-3.5 py-1 flex items-center gap-2 rounded sm:rounded-sm
                        transition-colors
                        `}
